            ...
            <section className='join-us'>
                <div className='container'>
                    <div className='join-us-context'>
                        <div className='join-context-title'><h1>Take the next step toward your personal and professional goals with Busilearn.</h1></div>
                        <div className='join-context-main'>Join now to receive personalized recommendations from the full Busilearn catalog.</div>
                        <div className='join-context-btn'><button>Join for Free</button></div>
                    </div>
